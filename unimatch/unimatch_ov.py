...
class UniMatch(nn.Module):
    def __init__(self,
        ...
        # parameters from the forward
        self.attn_type = kwargs.get("attn_type")
        self.attn_splits_list = kwargs.get("attn_splits_list")
        self.corr_radius_list = kwargs.get("corr_radius_list")
        self.prop_radius_list = kwargs.get("prop_radius_list")
        self.num_reg_refine = kwargs.get("num_reg_refine", 1)
        self.pred_bidir_flow = kwargs.get("pred_bidir_flow", False)
        self.task = task
        self.intrinsics = kwargs.get("intrinsics")
        self.pose = kwargs.get("pose")  # relative pose transform
        self.min_depth = kwargs.get("min_depth", 1. / 0.5)  # inverse depth range
        self.max_depth = kwargs.get("max_depth", 1. / 10)
        self.num_depth_candidates = kwargs.get("num_depth_candidates", 64)
        self.depth_from_argmax = kwargs.get("depth_from_argmax", False)
        self.pred_bidir_depth = kwargs.get("pred_bidir_depth", False)
    ...
    def forward(self, img0, img1
        ...
        depth_from_argmax = self.depth_from_argmax
        pred_bidir_depth = self.pred_bidir_depth
